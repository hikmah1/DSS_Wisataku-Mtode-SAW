    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Tambah Skala Baru</h5>

              <!-- General Form Elements -->
              <form action="act_skala_create.php" method="POST">

                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Nilai Skala</label>
                  <div class="col-sm-10">
                ...
                <div class="row mb-3">
                  ...
                  <div class="text-left">
                    <button type="submit" class="btn btn-primary">Tambahkan Skala</button>
                  </div>
                </div>
