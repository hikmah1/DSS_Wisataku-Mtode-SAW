...
<div class="card">
  <div class="card-body">
    <h5 class="card-title">Tambah Bobot Baru</h5>

    <!-- General Form Elements -->
    <form action="act_bobot_create.php" method="POST">
      ...
      <div class="row mb-3">
        <label for="inputText" class="col-sm-2 col-form-label">Besar Bobot</label>
        <div class="col-sm-10">
      ...
      <div class="row mb-3">
        ...
        <div class="text-left">
          <button type="submit" class="btn btn-primary">Tambahkan Bobot Baru</button>
        </div>
      </div>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <h5 class="card-title">Data Value Bobot</h5>
              ...
              <table class="table table-hover">
                ...
                <?php
                        ...
                        INNER JOIN kriteria
                        ON kriteria.id_kriteria = bobot.id_bobot ";
