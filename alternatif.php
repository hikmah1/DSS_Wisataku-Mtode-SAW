    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="alternatif.php" class="active">
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Tambah Alternatif Baru</h5>

              <!-- General Form Elements -->
              <form action="act_alternatif_create.php" method="POST">

                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Nama Alternatif</label>
                  <div class="col-sm-10">
                ...
                <div class="row mb-3">
                  ...
                  <div class="text-left">
                    <button type="submit" class="btn btn-primary">Tambahkan Alternatif</button>
                  </div>
                </div>
